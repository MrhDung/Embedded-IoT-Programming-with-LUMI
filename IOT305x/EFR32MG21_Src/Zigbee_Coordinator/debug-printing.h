...
// Printing macros for cluster: Set Distance
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER)
#define emberAfLd2410DistanceClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER, __VA_ARGS__)
#define emberAfLd2410DistanceClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfLd2410DistanceClusterFlush()
#define emberAfLd2410DistanceClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER) ) { x; }
#define emberAfLd2410DistanceClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER, (buffer), (len), (withSpace))
#define emberAfLd2410DistanceClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER, (buffer))
#else
#define emberAfLd2410DistanceClusterPrint(...)
#define emberAfLd2410DistanceClusterPrintln(...)
#define emberAfLd2410DistanceClusterFlush()
#define emberAfLd2410DistanceClusterDebugExec(x)
#define emberAfLd2410DistanceClusterPrintBuffer(buffer, len, withSpace)
#define emberAfLd2410DistanceClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LD2410_DISTANCE_CLUSTER)


// Printing macros for cluster: Set Latency
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER)
#define emberAfLd2410LatencyClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER, __VA_ARGS__)
#define emberAfLd2410LatencyClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfLd2410LatencyClusterFlush()
#define emberAfLd2410LatencyClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER) ) { x; }
#define emberAfLd2410LatencyClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER, (buffer), (len), (withSpace))
#define emberAfLd2410LatencyClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER, (buffer))
#else
#define emberAfLd2410LatencyClusterPrint(...)
#define emberAfLd2410LatencyClusterPrintln(...)
#define emberAfLd2410LatencyClusterFlush()
#define emberAfLd2410LatencyClusterDebugExec(x)
#define emberAfLd2410LatencyClusterPrintBuffer(buffer, len, withSpace)
#define emberAfLd2410LatencyClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LD2410_LATENCY_CLUSTER)


// Printing macros for cluster: Set Sensitivity
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER)
#define emberAfLd2410SensitivityClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER, __VA_ARGS__)
#define emberAfLd2410SensitivityClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfLd2410SensitivityClusterFlush()
#define emberAfLd2410SensitivityClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER) ) { x; }
#define emberAfLd2410SensitivityClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER, (buffer), (len), (withSpace))
#define emberAfLd2410SensitivityClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER, (buffer))
#else
#define emberAfLd2410SensitivityClusterPrint(...)
#define emberAfLd2410SensitivityClusterPrintln(...)
#define emberAfLd2410SensitivityClusterFlush()
#define emberAfLd2410SensitivityClusterDebugExec(x)
#define emberAfLd2410SensitivityClusterPrintBuffer(buffer, len, withSpace)
#define emberAfLd2410SensitivityClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LD2410_SENSITIVITY_CLUSTER)
