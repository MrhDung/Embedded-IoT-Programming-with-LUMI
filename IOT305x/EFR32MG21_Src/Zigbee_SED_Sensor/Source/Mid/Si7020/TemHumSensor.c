...
void Si7020_UpdateValueTempHumi (void)
{
	...
	{
		SEND_TempValueReport(ENDPOINT_1, currentTemp);
//		emberAfCorePrintln("Temp value changes greatly: %"PRIu32" oC", currentTemp);
	}
	...
	{
		SEND_HumiValueReport(ENDPOINT_1, currentHumi);
//		emberAfCorePrintln("Humi value changes greatly: %"PRIu32" %%", currentHumi);
	}
 ...
 *
 * @brief:		The function periodically updates the temperature and humidity values
 *
 * @params:		None
 *
 * @retVal:		None
